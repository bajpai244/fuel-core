use crate::{
    database::OnChainIterableKeyValueView, service::adapters::ConsensusParametersProvider,
};
use fuel_core_gas_price_service::{
    ...
    ports::{GasPriceData, GasPriceServiceConfig, L2Data},
};
use fuel_core_storage::{transactional::HistoricalView, Result as StorageResult};
use fuel_core_types::{
...
use crate::{
    database::{database_description::gas_price::GasPriceDatabase, Database},
    service::Config,
};
